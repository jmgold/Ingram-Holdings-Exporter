--print items and orders for Belmont, not included withdrawn, claims returned or lost & paid items
...
blm_bibs AS (
  ...
  FROM (
    SELECT
      ...
      WHERE i.location_code ~ '^blm'
        AND i.item_status_code NOT IN ('w','$','z')
    ...
    WHERE o.accounting_unit_code_num = '5'
